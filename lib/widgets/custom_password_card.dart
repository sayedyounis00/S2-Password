  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AddPasswordCubit, AddPasswordState>(
      builder: (context, state) {
        return BlocConsumer<AddPasswordCubit, AddPasswordState>(
          listener: (BuildContext context, AddPasswordState state) {
            if (state is AddPasswordSuccess) {
              BlocProvider.of<AddPasswordCubit>(context)
                  .addPassword(widget.password);
            }
          },
          builder: (context, state) {
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Clipboard.setData(
                            ClipboardData(text: widget.password.toString()));
                      },
                    )
                  ],
                ),
